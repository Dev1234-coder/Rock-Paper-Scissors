...
# insert picture
user_label = Label(root, image=scissor_img, bg="lime")
comp_label = Label(root, image=scissor_img_comp, bg="lime")
comp_label.grid(row=1, column=0)
user_label.grid(row=1, column=4)

# scores
playerScore = Label(root, text=0, font=("Arial", 15), bg="lime", fg="blue")
computerScore = Label(root, text=0, font=("Arial", 15), bg="lime", fg="blue")
computerScore.grid(row=1, column=1)
playerScore.grid(row=1, column=3)

# indicators
user_indicator = Label(root, font=("Arial", 15), text="USER", bg="lime", fg="red")
...
# messages
msg = Label(root, font=("Arial", 15), bg="lime", fg="green")
...
rock = Button(root, width=20, height=2, text="ROCK",
              bg="red", fg="black", font=("Arial", 15), command=lambda: updateChoice("rock")).grid(row=2, column=1)
paper = Button(root, width=20, height=2, text="PAPER",
               bg="purple", fg="black", font=("Arial", 15), command=lambda: updateChoice("paper")).grid(row=2, column=2)
scissor = Button(root, width=20, height=2, text="SCISSOR",
                 bg="blue", fg="black", font=("Arial", 15), command=lambda: updateChoice("scissor")).grid(row=2, column=3)
